    ...
    >
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
              I’m Md Momen Sha aka mrxvaau, A computer science engneering student majoring in Cybersecurity. I grind CTFs and Competitive Programming, blending hacking with logic. I specialize in web exploits (SQLi, XSS, LFI/RFI), binary pwn, and reverse engineering. Tools I live on: Kali Linux, Burp Suite, Nmap, Wireshark, Metasploit, and custom scripts via Termux + NetHunter on rooted Android. I research AI-powered threat detection — anomaly detection, phishing filters, automated incident response — aiming to build smarter, faster defense systems. I'm also the mind behind BrainWave, a student-focused all-in-one toolkit. I play chess (ELO 1376). Breaking systems to rebuild 'em stronger — that’s the mission.
            </p>
      ...
      >
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "The greatest pleasure is when you break a man's ego. "
        </blockquote>
      </div>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1stN7bFxSRKloz3o0giYq8lDjjSba0Nfj/view?usp=sharing" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
