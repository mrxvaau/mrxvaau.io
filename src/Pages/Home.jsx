...
const WORDS = ["Bug Bounty & Reverse Engineer", "Tech Enthusiast & Pentester"];   
const TECH_STACK = ["Python", "C/C++", "Assembly", "Sql" ,"Javascript"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/mrxvaau" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/mrx-vau-666715308/" },
  { icon: Instagram, link: "https://www.instagram.com/yours.joi/?hl=id" }
];
